//Arrow Function(화살표 함수) => 자바의 람다식과 같으며, ES6(2015)부터
/* 
1. 매개변수가 없는 경우
function 함수명(){ ... }
var 함수명 = function(){ ... }
...
4. 반환이 있는 경우
function 함수명(매개변수명1, 매개변수명2){ return 반환식또는 값; }
var 함수명 = function(매개변수명1, 매개변수명2){ return 반환식또는 값; }
var 함수명 = (변수명1, 변수명2) => { return 반환식또는 값; }
var 함수명 = (변수명1, 변수명2) => { 반환식또는 값; }
var 함수명 = (변수명1, 변수명2) => { 
    계산 또는 연산문 또는 명령;
    반환식또는 값; 
};
...
var fnc2 = (a,b) => console.log("계산결과 : "+(a+b));
var fnc3 = () => 27*27;
